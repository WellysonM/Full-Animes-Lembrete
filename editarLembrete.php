...
<html lang="pt-br">
    ...
    <div class="col-md-6 col-md-offset-3">
        ...
        <form ction="editarLembrete.php" method="get" class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" required="" name="lembrete" placeholder="Lembrente">
      <input type="hidden" class="input" value="<?php echo $_GET['id']; ?>" name="id">
    </div>
  </div>
  <div class="form-group">
